...
сам джанго располагается в папке /home/z/zdgalepv/mistery_ships/public_html/venv/lib/python2.7/site-packages
 
для начала надо переключиться на текущий virtualenv
заходим в папку с проектом
 
$ cd /home/z/zdgalepv/mistery_ships/public_html
$ source venv/bin/activate
 
проверяем правильно ли определился путь до pip:
$ which pip
/home/z/zdgalepv/mistery_ships/public_html/venv/bin/pip
...
$ pwd
/home/z/zdgalepv/mistery_ships/public_html/HelloDjango/HelloDjango/tmp
$ touch restart.txt


ssh zdgalepv@zdgalepv.beget.tech